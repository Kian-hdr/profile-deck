...
| Sparkle 2.9.6 | Bundled framework in the direct-download app | MIT with included notices in [Sparkle.txt](../THIRD_PARTY_LICENSES/Sparkle.txt). The 0.2.2 release does not configure a live update feed. |
